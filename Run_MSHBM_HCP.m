...
Paths{1} = '~/Apps/working_directory/bash_python_proj/PFM_MSHBM_MHVerbGen/res0urces/read_write_cifti';           % ft_read_cifti_mod, etc.
...
% Load dtseries
C = ft_read_cifti_mod(fullfile(BaseDir, Subject, 'MNINonLinear/Results/rfMRI_REST1_RL', 'rfMRI_REST1_RL_Atlas.dtseries.nii'));
